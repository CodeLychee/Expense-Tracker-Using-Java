...
public final class ExpenseTracker {
    ...
    private JPanel createLoginPanel(JPanel panel) {
        ...
        // ActionListener for showing the password
         ...
         * -> gets username and checks whether the user name exists or not
         *    if the user exists then it will show the password to the user
        */
        ...
        // Existing Register ActionListener
    ...
    //register the user and checks whether the user is already present or not
    ...
    //checks whether the username & password is correct and login the user   
    ...
    //saves the data in expenseData.dat and works as a database
